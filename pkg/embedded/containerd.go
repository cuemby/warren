...
// EnsureContainerd is defined in ensure_darwin.go (macOS) and ensure_linux.go (Linux)
// Platform-specific implementations handle embedded vs external containerd
